...
parser.add_argument('--arch', '-a', metavar='ARCH', type=str, required=True,
...
parser.add_argument('--pretrained', type=str, default=None,
                    help='"official" for using official PyTorch pre-trained model'
                         '"XXX/XXX/name.pth" for using locally pre-trained model.')
